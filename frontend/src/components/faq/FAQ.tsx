...
export const FAQ = () => {
    return (
        <section className="relative w-full min-h-screen overflow-hidden">
            ...
            <div className="absolute -bottom-32 sm:-bottom-48 md:-bottom-60 left-1/2 -translate-x-1/2 w-[150%] max-w-[2400px] h-[300px] sm:h-[400px] md:h-[520px] bg-white rounded-[50%]" />

            {/* Content container */}
            <div className="relative w-full mx-auto pt-12 md:pt-24 pb-20 md:pb-32 px-4 lg:px-8">
                {/* Header */}
                ...
                <div className="flex flex-col lg:flex-row gap-6 md:gap-8 items-center justify-center relative mx-auto max-w-7xl">
                    <div className="flex-shrink-0 z-20 w-full sm:w-[280px] md:w-[350px] lg:w-[700px]">
                        <FAQImage />
                    </div>

                    <div className="flex-1 z-20 max-w-[700px] w-full px-0 md:px-4 lg:-ml-26">
                        <FAQAccordion />
                    </div>
                </div>
            </div>
